...
df_campanha = pd.read_excel('CAMPANHA.xlsx')
...
df_supervisor_agrupado.to_excel('Comissão Supervisor.xlsx', index=False)
df_vendedor_agrupado.to_excel('Comissão Vendedor.xlsx', index=False)
df_final.to_excel('Planilha Geral.xlsx', index=False)